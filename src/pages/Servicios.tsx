...
const services = [
  {
    ...
    description: "Presentes desde la concepción de la idea: esquemas preliminares, evaluación de materiales, presupuesto y WBS con el cliente.",
    color: "primary",
  },
  {
    icon: PaintBucket,
    secondaryIcon: Hammer,
    title: "Diseño Multidisciplinario",
    description: "Planos de arquitectura, estructuras, eléctricos, sanitarios, mecánicos y metálicos, en alianza con arquitectos de primer nivel.",
    color: "accent",
  },
  {
    icon: Wrench,
    ...
    description: "Planeamiento, ejecución y control de procesos constructivos diseñados específicamente para cada proyecto especial.",
    color: "primary",
  },
  {
    icon: Network,
    ...
    description: "Procesos administrativos y constructivos preparados para gestionar la incertidumbre propia de los proyectos especiales.",
    color: "accent",
  },
];
